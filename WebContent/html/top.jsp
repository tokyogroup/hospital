...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_02.gif">
  <tr>
    <td width="40"><img src="../images/index_001.png" width="260" height="40"></td>
    <td align="right" valign="bottom"><table border="0" cellspacing="7" cellpadding="0">
      <tr>
        ...
        <td width="50" valign="bottom"><img src="../images/index_11.gif" width="20" height="16" align="absbottom"><a href="UserinfosServlet?method=logout" target="_parent" class="a02">退出</a></td>
