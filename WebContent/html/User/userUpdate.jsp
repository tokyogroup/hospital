    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">修改用户资料</td>
          </tr>
      </table></td>
    </tr>
  </table>
  <form name="form1" method="post" action="UserinfosServlet?method=updateUser2">
    <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td width="90" height="24" class="td_form01">用户ID</td>
        <td class="td_form02"><input name="u_id" type="text" class="input" required="required" value="${userForUpdate.u_id}" readonly="readonly"></td>
    </tr>
      <tr>
        <td width="90" height="24" class="td_form01">用户姓名</td>
        <td class="td_form02"><input name="u_name" type="text" class="input" required="required" value="${userForUpdate.u_name}"></td>
       ...
       <tr>  
        <td width="90" class="td_form01">用户密码</td>
         <td class="td_form02"><input name="u_pwd" type="password" class="input" required="required" value="${userForUpdate.u_pwd}"></td>
       
      
        <td width="90" height="24" class="td_form01">用户年龄</td>
        <td class="td_form02"><input name="u_age" type="text" class="input" required="required"value="${userForUpdate.u_age}"></td>
        </tr>
        ...
        <td class="td_form02"><input name="u_tel" type="text" class="input" required="required" value="${userForUpdate.u_tel}"></td>
        <td width="90" height="24" class="td_form01">用户邮箱</td>
        <td class="td_form02"><input name="u_email" type="text" class="input" required="required" value="${userForUpdate.u_email}"></td>  
      </tr>  
       ...
       <tr>
        ...
        <textarea name="u_exp" id="textarea" cols="70" rows="5" value="${userForUpdate.u_exp}"></textarea>
        </td>
      </tr>
