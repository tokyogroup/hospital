...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" background="../images/main_17.gif"><br>
      ...
      <tr>
        ...
        <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25"><img src="../images/main_28.gif" width="9" height="9" align="absmiddle"> <strong>待办事宜</strong></td>
            <td width="35" align="right"><a href="bpms/undo.jsp" target="mainFrame"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><img src="../images/spacer.gif" width="1" height="1"></td>
              ...
              <table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="120"><img src="../images/info_24.gif" width="104" height="76"></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/leaderSuggest.jsp" target="_blank"> <a href="bpms/employeeIn/shen_pi_qingjia.jsp" target="_blank">杨国春 在 2015-1-3发表了一篇手稿</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/shen_pi_qingjia.jsp" target="_blank">王强  提交请假待审批 办理时间 2015-1-8</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/ke_ti_jiekuan_shenpi.jsp" target="_blank">杨国春 在 2015-1-3发表了一篇手稿</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/shen_pi_yiliao_baoxiao.jsp" target="_blank">何凯  发表了一篇文章待审批办理时间2015-1-8</a></span></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="35" align="right"><a href="ti_xing\ti_xing.jsp" target="mainFrame"><img src="../images/main_53.gif" width="35" height="9" border="0"></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi.jsp" target="_blank">王强  提交请假待审批 办理时间 2015-1-8</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi.jsp" target="_blank">杨国春 在 2015-1-3发表了一篇手稿</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi.jsp" target="_blank">钱栋瑜 在 2015-1-3发表了一篇手稿</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi.jsp" target="_blank">屈碧勃 在 2015-1-3发表了一篇报告</span></a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="35" align="right"><a href="message/message.jsp"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2015-1-18 培训四班第三组全体成员到会议室开会</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">请及时处理杨过、何凯、胡汉三、刘晓东的培训申请</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2015-2-7 全体员工放假15天</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2015-2-6 下午在311举行春节员工晚会，请准时参加</a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
    ...
    <td width="190" align="center" valign="top" background="../images/main_17.gif"><br>
      ...
      <tr>
        <td height="25"><img src="../images/main_30.gif" width="9" height="9" align="absmiddle"> <strong>信息公告</strong></td>
        </tr>
      </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
//  End -->
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><a href="tongxunlu/index.jsp" target="mainFrame" class="a03">个人通讯录</a><br>
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><a href="../html/PersonalSet/showset.jsp" class="a03">个人设置</a><br>
                  <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
    </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
