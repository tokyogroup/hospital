...
<META http-equiv=Content-Type content="text/html; charset=GBK">
 ...
 <!--
    ...
    window.open ("zhong_xin_chu_na.htm", "newwindow2", "height=400, width=300, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
    ...
    window.open ("duan_xiao_xi.htm", "newwindow2", "height=400, width=300, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 

      } 
	  	 function openwin3() { 
	
    window.open ("xin_fen.htm", "newwindow2", "height=400, width=300, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
