  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">病人诊断信息资料</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td nowrap class=td_form02><input name="pi_id" id = "pi_id" type="text" class="input" size="25" ></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td>&nbsp;&nbsp;&nbsp;</td>
  <td>&nbsp;&nbsp;&nbsp;</td>
    <td align="center"><input name="submit2" type="button" class="buttonface" value="  返回  " onClick="window.location.href='Z_infor.jsp'"></td>
  <td>&nbsp;&nbsp;&nbsp;</td>
  <td>&nbsp;&nbsp;&nbsp;</td>
  </tr>
</table>
