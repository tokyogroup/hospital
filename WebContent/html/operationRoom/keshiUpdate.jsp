...
cellpadding="0">
          <tr>
            ...
            <td valign="bottom">修改科室</td>
          </tr>
      </table></td>
    </tr>
  </table>
  <form name="form1" method="post" action="SectionServlet?method=sectionUpdatePwd2&s_id=${sectionFind.s_id}">
    <table width=95% border=0 align=center cellpadding=0 cellspacing=0>
      <tr align="left" nowrap>
        <td width="78" height="24" align="center"  class=td_form01>科室名称</td>
        <td colspan="3" align="left"  class=td_form02><input name="s_name" value="${sectionFind.s_name }" type="text" class="input" 

size="45"></td>
</tr>
<tr>
        <td width="146" align="center"  class=td_form01>科室地址</td>
        <td colspan="3" align="left"  class=td_form02><input name="s_addr" value="${sectionFind.s_addr}"  type="text" class="input" 
